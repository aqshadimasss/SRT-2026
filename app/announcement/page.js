...
export default function InternshipAnnouncementPage() {
  ...
  const mockCandidates = [
    { id: 'SRT26-INT-001', name: 'Raditya Pratama', track: 'Autonomous Systems & Flight Coding', status: 'ACCEPTED' },
    { id: 'SRT26-INT-002', name: 'Siti Rahma', track: 'Aviation Electronics & PCB Design', status: 'ACCEPTED' },
    { id: 'SRT26-INT-003', name: 'Bambang Wijaya', track: 'Aerodynamics & Composite Manufacturing', status: 'ACCEPTED' },
    { id: 'SRT26-INT-004', name: 'Aulia Putri', track: 'Creative Media & Corporate PR', status: 'ACCEPTED' },
    { id: 'SRT26-INT-005', name: 'Fajar Hidayat', track: 'Autonomous Systems & Flight Coding', status: 'ACCEPTED' },
    { id: 'SRT26-INT-006', name: 'Rian Kurniawan', track: 'Aviation Electronics & PCB Design', status: 'WAITLISTED' },
    { id: 'SRT26-INT-007', name: 'Dina Lestari', track: 'Creative Media & Corporate PR', status: 'ACCEPTED' },
    { id: 'SRT26-INT-008', name: 'Andi Saputra', track: 'Aerodynamics & Composite Manufacturing', status: 'WAITLISTED' }
  ];
  ...
  return (
    <main>
      ...
      <section style={{ 
        ...
        alignItems: 'center',
        position: 'relative',
        background: 'radial-gradient(circle at center, #051624 0%, #000000 100%)',
        paddingTop: '140px',
        paddingBottom: '60px',
        overflow: 'hidden'
      }}>
        {/* Glowing holographic ambient overlays */}
        <div style={{ position: 'absolute', top: '-10%', left: '50%', transform: 'translateX(-50%)', width: '700px', height: '500px', background: 'radial-gradient(circle, rgba(0, 180, 216, 0.1) 0%, transparent 75%)', filter: 'blur(60px)', pointerEvents: 'none', zIndex: 1 }} />
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center', maxWidth: '800px' }}>
          ...
          <div className="breadcrumb animate-fade-in" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.03)', padding: '6px 16px', borderRadius: '50px', border: '1px solid rgba(255, 255, 255, 0.05)', marginBottom: '32px', fontSize: '0.85rem' }}>
            ...
            <Link href="/internship" style={{ color: 'rgba(255,255,255,0.5)', transition: 'color 0.2s' }} className="breadcrumb-link">Internship</Link>
            <span style={{ color: 'rgba(255,255,255,0.3)' }}>/</span>
          ...
          <p className="text-travel-desc animate-fade-in" style={{ margin: '0 auto', animationDelay: '0.1s', textAlign: 'center', color: 'rgba(255, 255, 255, 0.75)', fontSize: '1rem', maxWidth: '650px' }}>
            We are proud to welcome the new generation of researchers and makers. Prepare yourself for hands-on labs, engineering challenges, and intense flight tests.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '60px 0', background: '#020208', borderTop: '1px solid rgba(255, 255, 255, 0.03)', borderBottom: '1px solid rgba(255, 255, 255, 0.03)' }}>
        <div className="container" style={{ maxWidth: '650px' }}>
          <div style={{ background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)', borderRadius: '24px', padding: '32px', textAlign: 'center' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem', marginBottom: '24px' }}>Input your registered Full Name or Registration ID (e.g. SRT26-INT-001) to verify your individual status.</p>
              ...
              <div className="search-result-block animate-fade-in" style={{ marginTop: '24px', padding: '20px', borderRadius: '12px', background: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', textAlign: 'left' }}>
                {individualResult === 'NOT_FOUND' ? (
                  ...
                  <div>
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.9rem' }}>Learning Track: <span style={{ color: 'var(--accent-primary)', fontWeight: 600 }}>{individualResult.track}</span></p>
                    
                    {individualResult.status === 'ACCEPTED' ? (
                      <p style={{ color: '#4caf50', fontSize: '0.8rem', fontWeight: 600, marginTop: '12px' }}>✓ Welcome to the team! Check your email for welcoming track details and technical coordinate orientations.</p>
                    ) : (
